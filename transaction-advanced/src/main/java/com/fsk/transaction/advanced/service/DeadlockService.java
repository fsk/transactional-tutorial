...
public class DeadlockService {
     ...
     * 
     * Transaction 1: A'yı kilitle, sonra B'yi kilitle
     * Transaction 2: B'yi kilitle, sonra A'yı kilitle
     * → Deadlock!
     */
     ...
     * 
     * Bu method B'yi kilitle, sonra A'yı kilitle
     * Yukarıdaki method ile birlikte çağrılırsa deadlock oluşur
     */
    @Transactional(isolation = Isolation.REPEATABLE_READ)
